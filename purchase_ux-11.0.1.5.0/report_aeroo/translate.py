...
def extend_trans_generate(lang, modules, cr):
    ...
    model_data_obj = registry['ir.models.data']
    uid = 1

    query = 'SELECT name, models, res_id, module' \
            '  FROM ir_model_data'

    query_models = """SELECT m.id, m.models, imd.module
            FROM ir_model AS m, ir_model_data AS imd
            WHERE m.id = imd.res_id AND imd.models = 'ir.models' """
    ...
    query += ' ORDER BY module, models, name'
    query_models += ' ORDER BY module, models'
    ...
    for (xml_name,model,res_id,module) in cr.fetchall():
        ...
        if model=='ir.ui.view':
            ...
            pass # TODO Can models really be 'ir.actions.wizard' ?

        elif model=='ir.models.fields':
            try:
            ...
            if field_def.translate:
                ...
                for obj_value in obj_values:
                    res_id = obj_value['id']
                    if obj.name in ('ir.models', 'ir.ui.menu'):
                        res_id = 0
                    ...
                    if not model_data_ids:
                        push_translation(module, 'models', name, 0, encode(obj_value[field_name]))
        ...
        for field_name, field_def in obj._columns.items():
            if model == 'ir.models' and field_name == 'name' and obj.name == obj.model:
                # ignore models name if it is the technical one, nothing to translate
                continue
            if field_def.translate:
                ...
                try:
                    ...
                    term = ''
                push_translation(module, 'models', name, xml_name, encode(term))

        # End of data for ir.models.data query results
